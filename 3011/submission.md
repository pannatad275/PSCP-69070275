...
```text
ให้สีมาสามสีเป็นแม่สี แล้วนำมาผสมกันให้เป็นสีตามโจทย์กำหนด แล้วถ้าใส่สีที่ไม่ใช่แม่สีให้ขึ้นerror แล้วถ้าสีเดียวกันให้ขึ้นสีนั้น
```
...
```text
แผนแรกคือกำหนดตัวแปรขึ้นมาเก็บข้อมูลสี แล้วใช้ if else ตั้งคำสั่งตรวจว่ามีสีในตัวแปรที่เก็บสีมั้ยแล้วค่อยไปทำifซ้อนต่อ ตั้งตัวแปรว่าถ้านำแม่สีที่1มารวมกับแม่สีที่2จะได้อะไร ทำให้ครบตามโจทย์กำหนดแล้วไปใส่elseให้เชื่อมกับifอันแรกที่ทำแล้วให้ปริ้นerror
```
...
```text
วิธีสุดท้ายก็ตามแผนแรกเลยแค่ต้องอ่านโจทย์แล้วทำตามให้ดี
```
...
```text
ตามtestcaseแรกเลยเช็คคำตอบก่อน
```
...
```text
เลือกสีเดียวกันเพื่อเช็คว่าจะออกมาเป็นไร
```
...
```text
เลือกสีที่ไม่ใช่แม่สีแต่ใส่เดียวกันสองอัน
```
