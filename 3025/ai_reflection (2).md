...
```text
ถามว่าควรทำifซ้อนกันหรือทำifแยก
```
...
```text
ว่าควรทำแยกมากกว่าเพราะคำสั่งจะได้ไม่รวน
```
...
```text
แก้ใหม่หมดจากตอนแรกทำifซ้อนif เป็นทำifกำหนดเดือนก่อนค่อยไปหาว่าเดือนที่หาร3ลงตัวและวันที่21ขึ้นไปให้เปลี่ยนเดือน
```
...
```text
รู้ว่าควรทำifแยกจะได้ไม่รวนระบบ
```
