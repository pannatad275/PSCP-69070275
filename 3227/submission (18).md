...
```text
โจทย์ให้เราเอาชื่อย่อมาทำให้เป็นช่อเต็มของไพ่นั้น
```
...
```text
เอาตัวแรกของคำไปเปลี่ยนเป็นชื่อเต็ม เอาตัวสุดท้ายของคำไปเปลี่ยนเป็นชื่อดอกของมัน
```
...
```text
เหมือนแผนแรกไม่ต้องทำไรมาก if else พอ
```
