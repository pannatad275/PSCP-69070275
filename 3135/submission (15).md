...
```text
หาขโมยจากกลุ่มคนที่นั่งเป็นวงกลมให้เช็คไปเรื่อยวนเพิ่มทีละK แล้วถ้าไปตกที่โจรก็จะเอาไปเลย
แล้วถ้าวนครบ1รอบให้จบรอบเลย
```
...
```text
ถ้าตกที่โจรแต่แรกให้ปริ้น1เลย ถ้าไม่loop จนกว่าจะเจอคนร้ายหรือวนครบ1รอบ
```
