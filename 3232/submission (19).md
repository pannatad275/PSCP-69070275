...
```text
กระโดดให้ถึงตำแหน่ง y โดยกระดดทีละxแล้วลบทีละ2ต่อ1กระโดดถ้าโดดถึงปริ้นว่าโดดกี่ครั้งถ้าไม่ถึงให้ปริ้น-1
```
...
```text
รับค่าx y กระโดดหนึ่งทีcount + 1 แล้วถ้าถึงyแล้วให้break ถ้ายังไปลบ2ตรงx
```
...
```text
ลองว่าถ้าจุดเริ่มเป็นจุดจบจะต้องกระโดดมั้ย
```
