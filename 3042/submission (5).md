...
```text
โจทย์ให้รับค่าตัวเลขเป็นจำนวนเต็มบวกแล้วค่อยๆลดลงทีละ1จนเหลือ0แล้วตรวจสอบว่าตัวไหนหาร10แล้วลงตัวจะให้แสดงออกมาบนoutput
```
...
```text
กำหนดค่าตัวแปรรับค่าตัวเลขแล้วรูปให้ตัวเลขที่ให้มาลดลงทีละ1จนถึง0 แล้วตั้งคำสั่งifให้หาว่าอันไหนหารด้วย10ลงตัวให้printออกมา
```
...
```text
ตามแผนแรกแต่ต้องกลับไปทวนวิธีใส่ค่ารูปใหม่ในexcerciseว่าแต่ละช่องหมายถึงค่าอะไร star stop step
```
...
```text
ลองใส่ค่าลบดูเพื่อมันแสดงออกมา
```
