...
```text
ช่วยคิดว่าจะแปลงอุณหภูมิที่ให้มาเป็นcยังไง
```
...
```text
ช่วยสังเกตุขั้นตอนการทำว่าสามารถทำได้หลายแบบมากขึ้น
```
...
```text
แก้สมการที่ให้มาที่ต้องแปลงcเป็นอุณหภูมิอื่นยัไง
```
...
```text
รู้ว่าจะตั้งตัวแปรต้องเป็นตัวพิมพ์ใหญ่ไม่งั้นก็ต้องใส่def
```
