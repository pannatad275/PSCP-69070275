...
```text
โจทย์จะให้ใส่inputสองค่าคือคะแนนรวมและคะแนนเต็มสุดที่ใส่ได้ แล้วถ้าคะแนนสูงสุดกับต่ำสุดห่างกันเกิน2คะแนนจะทำให้คนอื่นรู้สึกแปลกๆคิดว่ามีหน้าม้าแต่ถ้าน้อยกว่าสองก็ปกติ
```
...
```text
ตั้งสมการว่าคะแนนรวมเท่ากับคะแนนมากสุด + คะแนนน้อยสุดหารสอง แล้วกลับสมการหาคะแนนน้อยสุด
แล้วเข้าคำสั่งif else ว่าถ้ามากสุด - น้อยสุด มากกว่า 2 ให้ขึ้นsuprise แต่ถ้าน้อยกว่าเท่ากับสองขึ้น notsurprise
```
...
```text
เหมือนวิธีแรกแต่ต้องเพิ่มเงื่อนไขif ว่าถ้าคะแนนน้อยสุดน้อยกว่า 0 ให้ขึ้นว่าคะแนนน้อยสุดเท่ากับ 0
```
...
```text
testว่าถ้าคะแนนน้อยสุดติดลบต้องขึ้นว่าอะไร
```
