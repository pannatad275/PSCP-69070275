...
```text
โจทย์ให้หาว่าถ้าเราอยุ่ห้องที่Nจะไปห้องที่1ต้องพังกำแพงกี่อัน แล้วรูปทรงของห้องเป็นพีระมิดลงมา
```
...
```text
สร้างพีระมิดตามจำนวนfloorที่ห้องNอยุ่ในนั้นโดยให้while loop แล้วหาว่าห้องที่Nห่างจากห้องริมสุดเท่าไหร่
แล้วหาต่อว่าจำนวนfloorในชั้นที่ห้องNอยุ่มีกี่ห้อง แล้วใช้คำสั่งif else ว่าถ้าจำนวนห้องที่ห่างหาร2ลงตัวมั้ยถ้าหารลงตัวพีระมิดจะเป็นแปปหัวแหลมตั้งขึ้น ถ้าไม่จะเป็นหัวแหลมตั้งลง ถ้าหัวแหลมตั้งขึ้นให้ - 1ถ้าตั้งลงให้ - 2
```
...
```text
เหมือนแผนแรกเลยแต่ต้องทำความเข้าใจกับความสัมพันธ์ระหว่างจำนวนห้องในชั้นนั้นเท่ากับจำนวนห้องที่จะไปถึง1
```
