...
```text
ช่วยให้รู้ว่าจำนวนห้องในชั้นเท่ากับจำนวนห้องที่Nไปถึงห้องที่1 และ รู้ว่าห้องขวาสุดเป็นห้องที่เอาเลขชั้นมายกกำลัง
```
...
```text
เพิ่มวิธีหาจำนวนห้องในชั้นนั้นและแก้จำนวนกำแพงที่ต้องทำลายให้อันที่หงายลบ1อันที่คว่ำลบ2
```
...
```text
รู้ว่าจำนวนห้องในชั้นนั้นคือจำนวนจากห้องNไปห้อง1
รู้ว่าพีระมิดแบบคว่ำมีกำแพงที่ติดกับข้างบนอยุ่แล้วเลยต้องลบ2
```
