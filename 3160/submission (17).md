...
```text
รับค่ามาหาว่าระหว่างn1 ถึงn2 มีจำนวนเฉพาะกี่ตัว โดย สร้างloopเริ่มจากn1จบn2 แล้วเขียนif ให้เริ่มจาก2 แล้วloopใหม่ให้เอาค่าเลขอันแรกมาหารด้วยเลขจาก1ถึงตัวมันถ้าหารแล้วลงตัวนับ+=1 ถ้านับรวมกันได้2 ให้ใส่ค่าลงlist
```
