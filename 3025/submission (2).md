...
```text
โจทย์ให้เขียนเดือนและวันที่ลงไปแล้วบอกฤดูการออกมา
```
...
```text
แผนแรกคือให้คิดก่อนว่าเดือนนี้อยุ่ในฤดูกาลอะไร แล้วค่อยดูว่าเดือน หารด้วย3ลงตัวมั้ยแล้วดูวันที่ว่ามากกว่า21มั้ย แต่ต้องน้อยกว่า31 
```
...
```text
เหมือนแผนแรกเลยแต่ปรับจากใช้คำสั่งifซ้อนกันเป็นหาแต่ละอันก่อน
```
...
```text
เพื่อตรวจสอบว่าตรงกับoutputมั้ย
```
...
```text
เพื่อดูว่าถ้าเดือนเกินจะเป็นไรจะขึ้นอะไร
```
