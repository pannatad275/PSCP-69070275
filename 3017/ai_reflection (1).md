...
```text
ให้ช่วยใบ้คำสั่งที่ต้องใช้และช่วยใบ้สมการที่ต้องเอามาคิดคำนวณ
```
...
```text
รู้ว่าคำสั่งที่ต้องใช้คืออะไร และเป็นคำสั่งใหม่ที่ได้รู้เลยได้ไปศึกษาต่อ และช่วยให้รู้ลำดับการคิดสมการ
```
...
```text
แก้สมการในการคิดราคาบวกค่าบริการและvat
```
...
```text
เรียนรู้วิธีคิดค่าย-บริการ และ การคิด vat
เรียนรู้ว่าคำสั่ง min and max ใช้ทำอะไร
```
