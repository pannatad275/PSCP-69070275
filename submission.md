...
```text
โจทย์ให้อ่านชื่อ แล้วสลับตัวอักษรเลียงจากหน้ามาหลัง และเป็นตัวพิมพ์เล็กทั้งหมด
input:
โปรแกรมรับชื่อคน
 output:
โปรแกรมควรพิมชื่อคนนั้นแต่เป็นตัวพิมพ์เล็ก และ สลับตัวอักษรจากหน้าไปหลัง
...
```text
step1:ตั้งinputใส่ชื่อขึ้นมาเป็นstring
step2:printชื่อที่ให้ออกมาแบบกลับด้านโดยใช้คำสั่ง[::-1]เพื่อให้ตัวอักษรสลับจากหน้ามาหลังและคำสั่งๅ.lower()เพื่อให้เป็นตัวพิมเล็ก
step3:รันแล้วลองใส่ค่าลงไป

รู้อยุ่แล้วว่าต้องใช้คำสั่งstr slicing และใช้ method แต่ไม่รู้ว่าต้องใส่ค่าอะไรตรง str slicing
```
...
```text
ใช้เหมือนแผนแรกแต่ปรับตัวเลขเล็กน้อยเพราะแผนแรกใส่ค่าแล้วoutputออกมาไม่ตรงกับoutputในโจทย์
```
...
```text
เลือกเพราะลองดูว่าเขียนแบบนี้จะเป็นยังไง
```
...
```text
ลองปรับวิธีเขียน str slicing เปลี่ยนตัวเลขและลองใส่ค่าใหม่
```
