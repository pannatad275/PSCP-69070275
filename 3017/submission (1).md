...
```text
โจทย์ให้คิดราคาอาหารที่รวมกับค่าบริการและvatตามที่ร้านกำหนด
...
```text
แผนคือให้หาค่าราคาที่รวมกับค่าบริการก่อนแล้วค่อยนำค่าราคาบวกค่าบริการไปรวมกับvatต่อ
...
```text
วิธีสุดท้ายก็เหมือนกับแผนแรกเลยคิดค่าบริการรวมกับราคาก่อนแล้วค่อยไปรวมกับvat
```
...
```text
จะได้ดูว่าตรงกับoutputของโจทย์มั้ย
```
...
```text
จะได้รู้ว่าต่ำกว่า50จะคิดค่ายริการ50มั้ย
```
...
```text
เลือกเพื่อตรวจคำตอบว่าตรงกับoutputมั้ย
```
