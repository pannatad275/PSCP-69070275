...
```text
ให้หาว่าถ้าซื้อของเท่านี้จะราคากี่บาทแล้วถ้าเป็นสมาชิกจะได้ลดกี่บาทแล้วถ้าไม่เป็นจะลดกี่บาท
```
...
```text
รวมราคาของที่ซื้อเช็คว่าเป็นสมาชิกมั้ยถ้าเป็นลดเท่านี้ถ้าไม่เป็นลดเท่านี้
```
