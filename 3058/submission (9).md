...
```text
สร้างสะพานโดยใช้อิฐเล็กและใหญ่ให้ใช้อิฐใหญ่ให้เยอะที่สุดแล้วค่อยใช้อิฐเล็ก
```
...
```text
เอาอิฐใหญ่มาหาว่าสามารถใช้ได้กี่อัน แล้วค่อยเอาที่เหลือให้เป้นอิฐเล็ก
```
...
```text
เหมือนวิธีแรกแต่ต้องเปลี่ยนวิธีการคำนวณ
```
