...
```text
โจทย์ให้แปลงค่าอุณหภูมิที่ให้มาเป็นค่าที่อยากได้
```
...
```text
แผนแรกคือแปลงอุณภูมิที่ให้มาในหน่วยนั้นแปลงเป็นอุณหภูมิในหน่วยC แล้วค่อยแปลงเป็นหน่วยที่ต้องการ
```
